...
run_step "extended_rejoin_regular_user" "$ROOT_DIR/backend/.venv/bin/python" "$ROOT_DIR/test_rejoin_simple.py" --user-email "$REGULAR_USER_EMAIL" --user-password "$REGULAR_USER_PASSWORD" || FAILED=1

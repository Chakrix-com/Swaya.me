...
export const themes = {
  ...
  'funky-studio': {
    ...
    cssVars: {
      ...
      '--sw-tile-cc-bg': 'rgba(167, 139, 250, 0.12)',
      '--sw-tile-cc-fg': '#A78BFA',
  ...
  'perky-game': {
    ...
    cssVars: {
      ...
      '--sw-tile-cc-bg': 'rgba(14, 165, 233, 0.09)',
      '--sw-tile-cc-fg': '#0284C7',
  ...
  // "Boardroom" — dark slate-navy + amber: mirrors the boardroom participant skin
  // but applied to the full host/admin app. Professional, polished, high-contrast.
  'boardroom': {
    id: 'boardroom',
    name: 'Boardroom',
    ...
    antd: {
      ...
      token: {
        ...
        colorBorder: 'rgba(248, 250, 252, 0.12)',
      ...
      components: {
        Button: { primaryColor: '#0F172A', fontWeight: 600 },
      },
    },
    proLayout: {
      bgLayout: '#0F172A',
      sider: {
        ...
        colorTextMenuSelected: '#F59E0B',
        colorBgMenuItemSelected: 'rgba(245, 158, 11, 0.14)',
        colorTextMenu: '#94A3B8',
        colorTextMenuTitle: '#F1F5F9',
        colorTextMenuItemHover: '#F1F5F9',
        colorBgMenuItemHover: 'rgba(248, 250, 252, 0.06)',
      },
      header: {
        colorBgHeader: '#1E293B',
        colorHeaderTitle: '#F1F5F9',
        colorTextMenu: '#94A3B8',
        colorTextMenuSelected: '#F59E0B',
        colorBgMenuItemSelected: 'rgba(245, 158, 11, 0.14)',
      },
    ...
    cssVars: {
      '--sw-primary':        '#F59E0B',
      '--sw-primary-strong': '#FBB830',
      '--sw-primary-soft':   'rgba(245, 158, 11, 0.14)',
      '--sw-primary-border': 'rgba(245, 158, 11, 0.35)',
      '--sw-success':        '#4ADE9E',
      '--sw-warning':        '#F59E0B',
      '--sw-error':          '#FF6B6B',
      '--sw-info':           '#38BDF8',
      ...
      '--sw-card':           '#1E293B',
      '--sw-surface':        '#1E293B',
      '--sw-border':         'rgba(248, 250, 252, 0.12)',
      '--sw-hover':          'rgba(248, 250, 252, 0.06)',
      '--sw-tile-quiz-bg':   'rgba(245, 158, 11, 0.12)',
      '--sw-tile-quiz-fg':   '#F59E0B',
      '--sw-tile-exam-bg':   'rgba(74, 222, 158, 0.12)',
      '--sw-tile-exam-fg':   '#4ADE9E',
      '--sw-tile-poll-bg':   'rgba(56, 189, 248, 0.12)',
      '--sw-tile-poll-fg':   '#38BDF8',
      '--sw-tile-opoll-bg':  'rgba(255, 107, 107, 0.12)',
      '--sw-tile-opoll-fg':  '#FF6B6B',
      '--sw-tile-cc-bg':     'rgba(167, 139, 250, 0.12)',
      '--sw-tile-cc-fg':     '#A78BFA',
      ...
      '--sw-chip-ready-bg':  'rgba(74, 222, 158, 0.16)',
      '--sw-chip-ready-fg':  '#4ADE9E',
      '--sw-chip-draft-bg':  'rgba(245, 158, 11, 0.16)',
      '--sw-chip-draft-fg':  '#F59E0B',
      '--sw-chip-done-bg':   'rgba(255, 255, 255, 0.08)',
      '--sw-chip-done-fg':   '#94A3B8',
      '--sw-chip-live-bg':   'rgba(56, 189, 248, 0.16)',
      '--sw-chip-live-fg':   '#38BDF8',
      '--sw-stat-ready-bg':  'rgba(74, 222, 158, 0.10)',
      '--sw-stat-works-bg':  'rgba(245, 158, 11, 0.10)',
      '--sw-stat-past-bg':   'rgba(56, 189, 248, 0.10)',
      '--sw-stat-icon-bg':   'rgba(255, 255, 255, 0.08)',
      '--sw-hero-bg':
        'radial-gradient(600px 300px at 85% -20%, rgba(245, 158, 11, 0.14), transparent 60%), ' +
        'radial-gradient(500px 280px at 0% 110%, rgba(56, 189, 248, 0.10), transparent 55%), ' +
        'linear-gradient(135deg, #1E293B 0%, #0F172A 100%)',
      '--sw-banner-bg':      'linear-gradient(135deg, rgba(245, 158, 11, 0.10) 0%, rgba(56, 189, 248, 0.08) 100%)',
      '--sw-banner-border':  'rgba(248, 250, 252, 0.12)',
      '--pub-bg':            '#0F172A',
      '--pub-card':          '#1E293B',
      '--pub-ink':           '#F1F5F9',
      '--pub-muted':         '#94A3B8',
      '--pub-line':          'rgba(248, 250, 252, 0.12)',
      '--pub-soft':          'rgba(248, 250, 252, 0.07)',
      '--pub-primary':       '#F59E0B',
      '--pub-on-primary':    '#0F172A',
      '--pub-quiz':          '#F59E0B',
      '--pub-poll':          '#38BDF8',
      '--pub-test':          '#4ADE9E',
      '--pub-opoll':         '#FF6B6B',
      '--pub-quiz-soft':     'rgba(245, 158, 11, 0.14)',
      '--pub-poll-soft':     'rgba(56, 189, 248, 0.14)',
      '--pub-test-soft':     'rgba(74, 222, 158, 0.14)',
      '--pub-opoll-soft':    'rgba(255, 107, 107, 0.14)',
      '--pub-beam':          'linear-gradient(90deg, #F59E0B, #FF6B6B 34%, #38BDF8 67%, #4ADE9E)',
      '--pub-shadow':        '0 30px 80px rgba(0, 0, 0, 0.50)',
      '--pub-cta-bg':        '#1E293B',
      '--pub-cta-text':      '#F1F5F9',
      '--pub-cta-muted':     '#94A3B8',
      '--pub-font-display':  "-apple-system, BlinkMacSystemFont, 'Segoe UI', 'Inter', sans-serif",
      '--pub-font-body':     "-apple-system, BlinkMacSystemFont, 'Segoe UI', 'Inter', sans-serif",
      '--pub-font-mono':     "source-code-pro, Menlo, Monaco, Consolas, monospace",
    },
  },
}

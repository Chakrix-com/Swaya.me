...
Usage:
  ...
  ENV_FILE=/path/to/backend/.env PYTHONPATH=. .venv/bin/python3 scripts/send_ai_feature_announcement.py --dry-run

  # Live send
  ENV_FILE=/path/to/backend/.env PYTHONPATH=. .venv/bin/python3 scripts/send_ai_feature_announcement.py
"""
